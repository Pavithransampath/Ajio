...
export const Login = () => {
    return (
        <div>
            ...
            <div className="con1">
                <Link to={'/Mens'}><img src="https://assets.ajio.com/cms/AJIO/WEB/D-1.0-UHP-01032024-BESTSELLERS-Z8-menswestern-upto80.jpg" alt="#" className="pro1"></img></Link>
                <Link to={'/Women'}><img src="https://assets.ajio.com/cms/AJIO/WEB/D-1.0-UHP-01032024-BESTSELLERS-Z8-womensethnic-starting249.jpg" alt="#" className="pro2"></img></Link>
                <Link to={'/Kids'}><img src="https://assets.ajio.com/cms/AJIO/WEB/D-1.0-UHP-01032024-BESTSELLERS-Z8-kidswear-starting249.jpg" alt="#" className="pro3"></img></Link>
                <Link to={'/Mobile'}> <img src="https://assets.ajio.com/cms/AJIO/WEB/D-1.0-UHP-01032024-BESTSELLERS-Z8-accessories-upto80.jpg " alt="#" className="pro4"></img></Link>
            </div>
